void handleLedFancy() {
  ...
  String content = "<html>";
  content += "<head><title>Ethernet Switchbox Fancy</title>\n<meta name=\"description\" content=\"Ethetnet Switchbox\"/>";
  ...
  content += "<body><div class=\"view\">\n     <div class=\"header-wrapper\">\n      <h1>Relay control Fancy</h1>\n</div>";

  content += "<table border=\"0\" align=\"center\"><tr><td><h3>Led control</h3></td></tr>";

  content += "<tr><td><form action=\"changeLedFancy\"><input type='submit' name='quickOn' value ='Allemaal Aan'></form></td>";
  content += "<td><form action=\"changeLedFancy\"><input type='submit' name='quickOff' value ='Allemaal Uit'></form></td>";
  content += "<td><form action=\"changeLedFancy\"><input type='submit' name='Reverse' value ='Reverse'></form></tr>";
  ...
  while (x != aantalKnoppen) {
    ...
    content += "</td><td>";
    content += "<form action=\"changeLedFancy\"><input type='submit' name='led' value='";
    content += x + 1;
    content += "'></form></td></tr>";
    x++;
  }
